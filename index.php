...
<head>
    ...
    <!--Favicon start-->
    <link rel="icon" type="image/png" href="assets/img/logon.png">
    <!--Favicon end-->
    ...
    <div class="topnavbar animated fadeIn">
        ...
        <ul class="topnavbar-nav">
            <li class="topnav-item">
                <a href="index.php"><img src="assets/img/logon.png" style="padding:-20px;margin-bottom:-10px;" alt="STFMS logo" class="logo logo-light"></a>            
            </li>
        </ul>
        <!-- end topnav left -->
        <!-- topnav right -->
...
<section class="hero_area">
 ...
 <section class="slider_section position-relative">
                        ...
                        <div class="container">
                            <div class="row mt-4">
                                ...
                                <div class="col-md-6 animated bounceInUp custom-slide-animi">
                                    <div class="img-box">
                                        <img src="assets/img/pngegg.png" style="height:450px;padding:30px;" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="container">
                            <div class="row mt-4">
                                ...
                                <div class="col-md-6 animated bounceInDown custom-slide-animi">
                                    <div class="img-box">
                                        <img src="assets/img/pngegg (1).png" style ="height:650px;" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item ">
                        <div class="container">
                            <div class="row mt-4">
                                ...
                                <div class="col-md-6 animated bounceInDown custom-slide-animi">
                                    <div class="img-box">
                                        <img src="assets/img/penalty-icon.png" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
  ...
  <svg class="hero_wave" xmlns="http://www.w3.org/2000/svg" ">
  </svg>
</section>
        ...
        <footer class="footer" id="footer">
            <div class="container animated fadeIn">
                <div class="row">
                    ...
                    <div class="footer-col">
                        <img class="footer-logo" style="height: 250px;margin:-60px;" src="assets/img/logon.png">
                    </div>
                </div>
            </div>
        </footer>
