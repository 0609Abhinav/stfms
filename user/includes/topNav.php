    ...
    <ul class="topnavbar-nav topnav-right">
        <li class="topnav-item">
            <div class="mydropdown">
                <p class="mydropdown-toggle pro-drop" data-toggle="user-menu">Settings 
                    <i class="fas fa-caret-down mydropdown-toggle" data-toggle="user-menu"></i>
                </p>
                <ul id="user-menu" class="mydropdown-menu">
                    ...
                    <li class="mydropdown-menu-item">
                       ...
                       <li class="topnav-item" >
                        <a href="../index.php" class="topnav-link" style="color: black;" >
