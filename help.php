    ...
    <div class="topnavbar animated fadeIn">
        ...
        <ul class="topnavbar-nav">
            <li class="topnav-item">
                <a href="index.php"><img src="assets/img/logon.png" alt="STFMS logo" class="logo logo-light"></a>
            </li>
        </ul>
        <!-- end topnav left -->
        <!-- topnav right -->
            ...
            <div class="container animated fadeIn">
                <div class="row">
                    <div class="footer-col">
                        ...
                        <ul>
                            <li><a href="tel:+94714590248"><i class="fas fa-phone"></i> +94 714590249</a></li>
                        </ul>
                    </div>
                    <div class="footer-col">
                        <h4>Inquiry via email</h4>
                        <ul>
                            <li><a style="text-transform: lowercase;" href="mailto:crafthouse@gmail.com" target="_blank"> <i class="fas fa-envelope"></i> stfms@gmail.com</a></li>
                        </ul>
                    </div>
                    <div class="footer-col">
                        <h4>Get help</h4>
